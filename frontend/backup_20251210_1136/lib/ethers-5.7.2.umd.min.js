    ...
    <div id="main-frame-error" class="interstitial-wrapper ">
      <div id="main-content">
        ...
        <div id="main-message">
          ...
          <!--?lit$412656148$-->
            <p>Comprueba si hay un error de escritura en <span>cdn.ethers.io</span>.</p>
          ...
          <!--?lit$412656148$-->
            <div id="suggestions-list">
              ...
              <ul class="single-suggestion">
                <!--?lit$412656148$--><!---->
                  <li>Si está escrito correctamente, <a href="javascript:diagnoseErrors()" id="diagnose-link">prueba a ejecutar el diagnóstico de red de Windows</a>.</li>
                <!---->
              </ul>
            </div>
          

          <div class="error-code"><!--?lit$412656148$-->DNS_PROBE_FINISHED_NXDOMAIN</div>
      ...
      <div id="buttons" class="nav-wrapper suggested-left">
        <div id="control-buttons">
          <!--?lit$412656148$-->
            <button id="reload-button" class="blue-button text-button" data-url="https://cdn.ethers.io/lib/ethers-5.7.2.umd.min.js">
              <!--?lit$412656148$-->Volver a cargar
            </button>
    ...
    <!--?lit$412656148$-->
      <div id="sub-frame-error">
        <!-- Show details when hovering over the icon, in case the details are
             hidden because they're too large. -->
        <div class="icon "></div>
        <div id="sub-frame-error-details">Comprueba si hay un error de escritura en <span>cdn.ethers.io</span>.</div>
      </div>
...
<script>var loadTimeDataRaw = {"details":"Detalles","errorCode":"DNS_PROBE_POSSIBLE","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontfamilyMd":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"msg":"No se puede acceder a este sitio web"},"hideDetails":"Ocultar detalles","iconClass":"icon-generic","language":"es","reloadButton":{"msg":"Volver a cargar","reloadUrl":"https://cdn.ethers.io/lib/ethers-5.7.2.umd.min.js"},"suggestionsDetails":[],"suggestionsSummaryList":[{"summary":"\u003Ca href=\"javascript:diagnoseErrors()\" id=\"diagnose-link\">Prueba a ejecutar Diagnósticos de red de Windows\u003C/a>."}],"summary":{"msg":"No se ha podido encontrar la \u003Cabbr id=\"dnsDefinition\">dirección DNS\u003C/abbr> de la página \u003Cstrong>cdn.ethers.io\u003C/strong>. Se está diagnosticando el problema."},"textdirection":"ltr","title":"cdn.ethers.io"};</script></body></html>